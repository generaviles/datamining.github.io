...
CCA helps us answer the question: \textbf{\emph{What is the best way to
understand how the variable sin two sets are related? }}, mathematically
speaking: \textbf{\emph{what linear combinations of the \(X\) variables
(\(u\)) and the Y vairables (\(t\)) will maximize their correlation?}}
